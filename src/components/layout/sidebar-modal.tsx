...
const SidebarModal: React.FC<SidebarModalProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed rounded-lg md:rounded-none top-0 right-0 md:w-1/2 w-full h-full bg-light-white dark:bg-dark-darkGray shadow-lg z-50 flex flex-col overflow-hidden ">
