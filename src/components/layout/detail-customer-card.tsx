  ...
  return (
    <div className="flex flex-col items-center relative">
      ...
      <div className="w-full flex flex-col items-center">
        <div className="mt-3 text-black dark:text-font-white text-lg font-medium font-custom md:text-2xl text-center w-full">
          <p className="truncate w-1/2 translate-x-1/2">{data?.name}</p>
        </div>
