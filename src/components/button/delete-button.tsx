...
const DeleteButton: React.FC<DeleteButtonProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="bg-dark-redLight dark:bg-[#E0283A] rounded-[10px] inline-flex items-center justify-center p-2 hover:opacity-80 transition-shadow duration-200"
    >
      <svg
        viewBox="0 0 20 22"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-dark-red dark:fill-light-white w-4 h-4 md:w-6 md:h-6 "
      >
