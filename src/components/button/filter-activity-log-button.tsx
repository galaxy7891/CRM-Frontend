...
interface FilterActivityLogButtonProps {
...
const FilterActivityLogButton: React.FC<FilterActivityLogButtonProps> = ({
  setSortBy,
  setStatusBy,
  setPerPage,
}) => {
      ...
      {isOpen && (
        <div className="z-50 absolute right-0 mt-2 px-5 py-6 bg-font-white dark:bg-dark-navy border border-font-gray rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            <Filter
              isActive={tempFilter.statusBy == "leads"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "leads" })
              }
            >
              Leads
            </Filter>
            <Filter
              isActive={tempFilter.statusBy == "kontak"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "kontak" })
              }
            >
              Kontak
            </Filter>
            <Filter
              isActive={tempFilter.statusBy == "karyawan"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "karyawan" })
              }
            >
              Karyawan
            </Filter>
            <Filter
              isActive={tempFilter.statusBy == "deals"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "deals" })
              }
            >
              Deals
            </Filter>
            <Filter
              isActive={tempFilter.statusBy == "produk"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "produk" })
              }
            >
              Produk
            </Filter>
            <Filter
              isActive={tempFilter.statusBy == "perusahaan"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "perusahaan" })
              }
            >
              Perusahaan
            </Filter>
          ...
          <Filter
            ...
            <Filter
              isActive={tempFilter.statusBy == "pelanggan"}
              onClick={() =>
                setTempFilter({ ...tempFilter, statusBy: "pelanggan" })
              }
            >
              Pelanggan
            </Filter>
...
export default FilterActivityLogButton;
