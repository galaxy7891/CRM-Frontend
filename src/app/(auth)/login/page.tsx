      ...
      <div className="flex flex-col p-7 lg:flex-row h-screen items-center justify-center w-full lg:w-1/2 bg-light-white">
        <div className="bg-font-white w-full mx-auto lg:w-full lg:mx-auto rounded-lg h-full lg:max-h-screen flex flex-col p-3 lg:px-14">
          ...
          <FormComponent
            ...
            buttonText="Masuk"
          />
          <div className="text-center my-2 font-small font-custom lg:text-base">Atau</div>
          <button
            type="button"
          ...
          <div className="mt-auto text-center flex items-center justify-center mb-4">
            <a className="text-xs font-custom lg:text-base font-medium">Belum punya akun?</a>
            <a href="/register-email" className="text-xs lg:text-base font-custom text-light-gold font-bold ml-1">
              Buat Akun
            </a>
          </div>
        </div>
