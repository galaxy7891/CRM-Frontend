        ...
        <div className="grid grid-cols-12 ">
          ...
          <div className="col-span-12 lg:col-start-5 lg:col-span-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 mt-2 bg-light-white dark:bg-dark-darkGray rounded-[10px]">
              ...
              <CustomerInfo label="Kecamatan" value={contact?.subdistrict} />
              <CustomerInfo label="Kelurahan/Desa" value={contact?.village} />
              <CustomerInfo label="Kode Pos" value={contact?.zip_code} />
              <CustomerInfo label="Penanggung Jawab" value={contact?.owner} />
              <CustomerInfo label="Deskripsi" value={contact?.description} />
            </div>
          </div>
        </div>
