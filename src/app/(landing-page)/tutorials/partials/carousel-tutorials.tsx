...
interface CarouselTutorialsProps {
  items: CarouselTutorialsItem[];
}

const CarouselTutorials: React.FC<CarouselTutorialsProps> = ({ items }) => {
...
export default CarouselTutorials;
